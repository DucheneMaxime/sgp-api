...
insert into collaborateur (matricule, nom, prenom, date_de_naissance, adresse, numero_de_securite_sociale, dep_id, banque_id) values ('H01', 'Sony', 'Lauret', '2008-07-04', 'blabla test', '01233520549', 1, 1);
insert into collaborateur (matricule, nom, prenom, date_de_naissance, adresse, numero_de_securite_sociale, dep_id, banque_id) values ('H02', 'Sonix', 'Le lynx', '2012-12-12', 'test encore', '0856975252', 2, 2);
